...
function coinGeckoApi() {
  ...
  fetch("https://api.coingecko.com/api/v3/coins/markets?vs_currency=eur&ids=litecoin&sparkline=true&price_change_percentage=1h%2C24h%2C7d%2C14d%2C30d%2C1y", myInit)
...
function coinbaseApi() {
    ...
    fetch('https://api.pro.coinbase.com/products/LTC-EUR/ticker')
        .then(function (response) {
            ...
            siteTitle[0].textContent = 'LTC €' + parseFloat(coin.price).toFixed(2) + ' - Crypto Coins Now';
